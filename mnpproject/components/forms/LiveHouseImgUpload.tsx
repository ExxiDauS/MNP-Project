...
const LiveHouseImgUpload: React.FC<AvatarUploadProps> = ({
  ...
  return (
    <div className={`space-y-4 flex flex-col items-center ${className}`}>
      ...
      <div className="relative">
        <Avatar
          className={`w-56 h-36 cursor-pointer border-2 rounded-md ${errorMessage ? 'border-red-500' : 'border-zinc-600'}`}
...
export default LiveHouseImgUpload;
