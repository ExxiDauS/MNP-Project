  ...
  return (
    <>
      <div className="flex justify-center items-center">
        <section className="relative flex justify-center items-center w-screen mt-24 sm:px-6 md:px-8 ">
          {/* Larger aura effect background */}
          <div className="absolute w-full -inset-10 bg-gradient-to-r from-purple-500/30 via-pink-500/30 to-purple-500/30 blur-2xl rounded-4xl"></div>

          {/* Content container */}
          <div className="relative flex flex-col w-11/12 bg-custom-background-elevated outline outline-custom-purple-light outline-offset-2 rounded-3xl p-4 sm:p-6 md:p-10">
            <DetailHeader
              name={livehouse.name}
